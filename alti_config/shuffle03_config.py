...
COMMON_JAVA_OPTS = [
    ...
    JavaOptionSet("spark.shuffle.compress", [False]),
    JavaOptionSet("spark.shuffle.spill.compress", [False]),
    JavaOptionSet("spark.shuffle.io.numConnectionsPerPeer", [1]),
...
if MLLIB_SPARK_VERSION >= 1.2:
    ...
    if MLLIB_SPARK_VERSION >= 1.4:
        ensembleTypes.extend(["RandomForest", "GradientBoostedTrees"])
